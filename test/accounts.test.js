...
import { login, register, del, role } from "../modules/accounts.js?db=test"
...
Deno.test("login with worng user name", async () => {
    ...
    assertEquals(test, "user worngName not found", "login with worng user name fail")
})
...
Deno.test("login with worng password", async () => {
    ...
    assertEquals(test, "worng password for host", "login with worng password fail")
})
...
Deno.test("registing with already exists username", async () => {
    ...
    assertEquals(test, "username test already exists", "registing with already exists username fail")
})
...
Deno.test("delete non exists account", async () => {
    ...
    assertEquals(test, "username test not exists", "delete non exists account fail")
})
